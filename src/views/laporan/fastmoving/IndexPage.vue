          ...
          <tbody>
            <template v-for="(item, i) in store.items" :key="i">
              ...
              <tr class="border-b last:border-0">
                ...
                <td class="text-right pr-2">{{ formatRupiah(item?.jumlah_penjualan) }}</td>
                <td class="text-right pr-2">{{ formatRupiah(item?.total_harga_jual) }}</td>
                <td class="text-right pr-2">{{ formatRupiah(item?.jumlah_retur) }}</td>
                <td class="text-right pr-2">{{ formatRupiah(item?.total_harga_retur) }}</td>
                <td class="text-right pr-2">{{ formatRupiah(item?.total_penjualan) }}</td>
                <td class="text-right pr-2">{{ formatRupiah(item?.total_harga_bersih) }}</td>
              </tr>
            </template>
          </tbody>
